# LEGO Stores in Switzerland

3 stores on record, 3 open.

See [Switzerland on Brick Passport](https://brickstorestamps.com/explore/stores/list/europe/switzerland) for the stamps collected in these stores.

| Store | City | Address | Status | Services | Map |
| --- | --- | --- | --- | --- | --- |
| [LEGO Shop-in-Shop Manor Genève](https://brickstorestamps.com/stores/store-lego-shop-in-shop-manor-geneve) | Geneva | Rue de Cornavin 6, Genève 1201, Switzerland | Open | – | [map](https://www.openstreetmap.org/?mlat=46.20718&mlon=6.14272#map=17/46.20718/6.14272) |
